  ...
  module Framework
    ...
    class PinpointAgent < JavaBuildpack::Component::BaseComponent
      ...
      def initialize(context)
        ...
        @collector_host, @collector_span_port, @collector_stat_port, @collector_tcp_port = find_pinpoint_credentials if supports?
	@application_name = vcap_application_name 
      end
...
=end
      ...
      def find_pinpoint_credentials
        ...
        [collector_host, collector_span_port, collector_stat_port, collector_tcp_port]
      end
